    ...
    <div className="relative">
      <Link ref={trigger} onClick={() => setDropdownOpen(!dropdownOpen)} className="flex items-center gap-4" to="#">
        <span className="hidden text-right lg:block">
          <span className="block text-sm font-medium text-black dark:text-white">{user?.name ? user.name.toUpperCase() : 'Admin'}</span>
      ...
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          ...
          <Link className="block flex-shrink-0 lg:hidden" to="/">
            <img width={32} height={32} src={'/images/logo/logo-icon.svg'} alt="Logo" />
          </Link>
        </div>
